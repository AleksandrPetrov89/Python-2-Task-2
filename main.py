...
if __name__ == '__main__':
    contacts_list = reading_phonebook("phonebook_raw.csv")
    fixing_phonebook(contacts_list)
    print_phonebook(contacts_list)
    write_phonebook("phonebook.csv", contacts_list)
